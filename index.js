...
fs.writeFile('index.html', indexPage(name, id), err => {
    if (err) throw err;

    console.log('check out manager html');
} )
...
//     .then(promptEngineer)
//     .then(promptAnswers => console.log(promptAnswers));

// const promptEngineer = (engineerInfo) => {
//     //Create a new engineer array property
